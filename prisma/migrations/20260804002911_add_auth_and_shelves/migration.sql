-- CreateEnum
CREATE TYPE "ShelfKind" AS ENUM ('UNREAD', 'READ', 'CUSTOM');
...
CREATE TABLE "Shelf" (
    ...
    "userId" TEXT NOT NULL,
    "name" TEXT NOT NULL,
    "kind" "ShelfKind" NOT NULL DEFAULT 'CUSTOM',
...
-- CreateIndex
CREATE INDEX "Shelf_userId_position_idx" ON "Shelf"("userId", "position");

-- CreateIndex
CREATE UNIQUE INDEX "Shelf_userId_name_key" ON "Shelf"("userId", "name");

-- CreateIndex
CREATE INDEX "ShelfItem_shelfId_position_idx" ON "ShelfItem"("shelfId", "position");

-- CreateIndex
CREATE INDEX "ShelfItem_userId_idx" ON "ShelfItem"("userId");

-- CreateIndex
CREATE INDEX "ShelfItem_googleBooksId_idx" ON "ShelfItem"("googleBooksId");
...
-- AddForeignKey
ALTER TABLE "ShelfItem" ADD CONSTRAINT "ShelfItem_bookId_fkey" FOREIGN KEY ("bookId") REFERENCES "Book"("id") ON DELETE SET NULL ON UPDATE CASCADE;
